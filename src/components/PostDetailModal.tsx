...
const PostDetailModal: React.FC<PostDetailModalProps> = ({
  ...
  const postLiked =
    currentUserId &&
    post.likes?.some((u: any) => (u._id || u) === currentUserId);
          ...
          <div className="post-detail-comments-list">
            ...
            {post.comments?.map((c) => {
              const isCommentLiked =
                currentUserId &&
                c.likes?.some(
                  (id: any) => (id._id || id) === currentUserId
                );
          ...
          <footer className="post-detail-footer">
            <div className="post-detail-actions">
              ...
              >
                <div className="detail-main-btns">
                  ...
                  <button
                    onClick={onShare}
                    className="detail-action-btn share-accent"
                  >
                    <Send size={28} />
                  </button>
            ...
            <div className="detail-comment-input-container">
              ...
              <button
                ...
                disabled={
                  !commentText.trim() || loadingComment
                }

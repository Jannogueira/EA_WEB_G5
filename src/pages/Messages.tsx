...
const Messages: React.FC = () => {
  ...
  const getParentSenderName = (msg: any) => {
    ...
    return typeof msg.parentMessage.remitente === "string" ? "" : msg.parentMessage.remitente.nombre || "";
  };
            ...
            <>
              <header className="chat-header">
                ...
                <div
                  ...
                  onClick={() => !activeContact.isGroup && navigate(`/profile/${activeContact._id}`)}
                    ...
                    >
                      ...
                      >
                        {getSenderId(msg) !== usuario?._id && (
                          <div className="msg-sender-avatar" onClick={() => navigate(`/profile/${getSenderId(msg)}`)} style={{ cursor: 'pointer' }}>
                            <img src={getSenderAvatar(msg)} alt="" />
                          </div>
                        )}
                        <div className={`message-bubble ${getSenderId(msg) === usuario?._id ? "own" : "received"} ${msg.eliminadoParaTodos ? "deleted-msg" : ""} ${msg.post ? "post-msg" : ""}`}>
                          ...
                          {!msg.eliminadoParaTodos && (
                            <div className="message-hover-actions">
                              ...
                              <button
                                className="msg-action-btn"
                                onClick={() => handleDeleteClick(msg._id, getSenderId(msg) === usuario?._id)}
                              >
                                <Trash2 size={14} />
                              </button>

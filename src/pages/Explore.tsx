...
const ExplorePostModal: React.FC<{ post: Post; onClose: () => void; currentUserId: string | null }> = ({ post, onClose, currentUserId }) => {
    ...
    const performSearch = useCallback(
        async (pageNum: number, isNewSearch: boolean = false) => {
            try {
                ...
                const res = await searchUsers(search, selectedFilters, universidades, grados, asignaturas, pageNum);

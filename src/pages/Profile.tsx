...
const Profile: React.FC = () => {
  ...
  const getName = (obj: any) => (typeof obj === 'string' ? obj : obj?.nombre);
  ...
  if (!profileUser && !loading)
    return <div className="state-message">{t('profile.not_found')}</div>;
                    ...
                    {(profileUser?.universidad ||
                      ...
                      <div className="academic-info-univy">
                        ...
                        <div className="academic-item">
                          <span className="academic-value">
                            <NotebookPen size={15} className="btn-icon" />{' '}
